...
import exp_1_s2_grupo15.Cliente;
import exp_1_s2_grupo15.CuentaCorriente;
import exp_1_s2_grupo15.CuentaDeAhorro;
import exp_1_s2_grupo15.CuentaDeCredito;
        ...
        sc.nextLine();
            ...
            switch (opcion1){
                         ...
                         switch (opcion){
                            ...
                            case 1:
                                ...
                                System.out.println("Ingrese monto a depositar");
                                    ...
                                    sc.nextLine();
                                    ClienteActual.getCuentaBancaria().depositar(monto);
                            ...
                            case 2:
                                ...
                                System.out.println("Ingrese monto a girar");
                                    ...
                                    sc.nextLine();
                                    ClienteActual.getCuentaBancaria().girar(montoGiro);
                                    break;
                ...
                case 2:
                        ...
                        while (!tipoValido){
                            ...
                            switch (tipoCuenta){
                                ...
                                case 2:
                                    ...
                                    break;
                                case 3: 
                                    cuenta= new CuentaDeCredito();
                                    tipoValido = true;
                                    break;
                                default:
                                    System.out.println("Tipo de cuenta invalido, intente nuevamente.\n");
                    ...
                    System.out.println("Su nuevo numero de cuenta es: "+ nuevoCliente.getCuentaBancaria().getNumeroCuenta());
